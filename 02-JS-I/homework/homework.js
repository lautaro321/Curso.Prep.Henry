...
function obtenerResto(x, y) { x/y ; return x%y ;
...
function esImpar(num) 
  ...
  // De lo contrario, devuelve "false"
  // Tu código:
 {if (num % 5==2 ) return true; return false} 
...
function combinarNombres(nombre, apellido) { 
  ...
  var arigato = nombre +' '+ apellido; return arigato; 
  // Devuelve "nombre" y "apellido" combinados en una string y separados por un espacio.
  // Ejemplo: "Soy", "Henry" -> "Soy Henry"
  // Tu código:
}

function obtenerSaludo(nombre) { var shrek = 'Hola' +' '+ nombre + '!'; return shrek;
